...
<div style="height: 150px; background-color: #000; margin-top:15px">
  <div class="container" style="text-align: center">
    ...
    <p style="color: #fff; display:inline-block; margin-left:15px" id="footer_tel"><img src="<?php bloginfo('stylesheet_directory');?>/img/iconetel.png"/> 11 3522-7295</p>
    <p style="color: #fff; display:inline-block; margin-left:15px" id="footer_tel"><img src="<?php bloginfo('stylesheet_directory');?>/img/iconewhatsapp.png"/> 11 9.9772-7085</p>
